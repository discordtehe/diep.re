...
-(void)touchesMoved:(void *)arg2 withEvent:(void *)arg3 {
    ...
    v9 = v1;
    [r23 release];
    if (CGRectContainsPoint([r21 bounds], @selector(bounds)) == 0x0 || ([r21 isPressed] & 0x1) != 0x0) goto loc_10038a1b8;
...
loc_10038a1b8:
    if ((CGRectContainsPoint([r21 bounds], @selector(bounds)) & 0x1) != 0x0 || [r21 isPressed] == 0x0) goto loc_10038a210;
