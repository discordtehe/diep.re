@implementation FBNativeAdCollectionViewCellProvider
...
-(long long)collectionView:(void *)arg2 numberOfRowsInSection:(long long)arg3 {
    r0 = [self manager];
    r0 = [r0 retain];
...
-(void *)collectionView:(void *)arg2 cellForItemAtIndexPath:(void *)arg3 {
    ...
    r19 = [arg2 retain];
    r20 = [arg3 retain];
    r0 = [r21 uniqueCollectionCellIdentifier];
    r29 = &saved_fp;
    r0 = [r0 retain];
    [r0 release];
    if (r0 == 0x0) {
            ...
            [r21 setUniqueCollectionCellIdentifier:r24];
            [r24 release];
            [r0 release];
            r24 = [r21 type];
            r25 = [[r21 attributes] retain];
            r23 = [FBNativeAdCollectionViewCell specializeCellForType:r24 forAttributes:r25];
            [r25 release];
            r0 = [r21 uniqueCollectionCellIdentifier];
            r29 = r29;
            r24 = [r0 retain];
            [r19 registerClass:r23 forCellWithReuseIdentifier:r24];
            [r24 release];
    }
    r22 = [[r21 uniqueCollectionCellIdentifier] retain];
    r23 = [[r19 dequeueReusableCellWithReuseIdentifier:r22 forIndexPath:r20] retain];
    [r22 release];
    r21 = [[r21 collectionView:r19 nativeAdForRowAtIndexPath:r20] retain];
    [r20 release];
    [r23 populate:r21];
    [r21 release];
    [r19 release];
...
-(void).cxx_destruct {
    objc_storeStrong((int64_t *)&self->_uniqueCollectionCellIdentifier, 0x0);
    objc_storeStrong((int64_t *)&self->_attributes, 0x0);
    return;
}

-(void *)collectionCellIdentifier {
    r0 = [self uniqueCollectionCellIdentifier];
    return r0;
}

-(double)collectionView:(void *)arg2 heightForRowAtIndexPath:(void *)arg3 {
    r31 = r31 - 0x60;
    var_40 = d9;
    stack[-72] = d8;
    var_30 = r24;
...
-(void *)uniqueCollectionCellIdentifier {
    r0 = self->_uniqueCollectionCellIdentifier;
    return r0;
}

-(void)setUniqueCollectionCellIdentifier:(void *)arg2 {
    objc_storeStrong((int64_t *)&self->_uniqueCollectionCellIdentifier, arg2);
    return;
}
...
+(void)initialize {
    ...
    r29 = &saved_fp;
    r19 = self;
    r0 = objc_getClass("FBNativeAdCollectionViewCellProvider");
    if (r0 != 0x0) {
            r20 = r0;
