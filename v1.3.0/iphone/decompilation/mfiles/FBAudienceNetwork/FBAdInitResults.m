...
-(void *)initWithSuccess:(bool)arg2 message:(void *)arg3 {
    r31 = r31 - 0x40;
    var_20 = r22;
    stack[-40] = r21;
    var_10 = r20;
    ...
    r22 = r0;
    if (r0 != 0x0) {
            *(int8_t *)(int64_t *)&r22->_success = r21;
            objc_storeStrong((int64_t *)&r22->_message, r19);
    }
    [r20 release];
    r0 = r22;
    return r0;
...
+(void)initialize {
    ...
    r29 = &saved_fp;
    r19 = self;
    r0 = objc_getClass("FBAdInitResults");
    if (r0 != 0x0) {
            r20 = r0;
