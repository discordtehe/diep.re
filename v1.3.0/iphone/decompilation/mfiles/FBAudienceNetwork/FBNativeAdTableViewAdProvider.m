@implementation FBNativeAdTableViewAdProvider
...
-(void *)initWithManager:(void *)arg2 {
    ...
    if (([r0 isValid] & 0x1) != 0x0) {
            ...
            [FBAdDebugLogging logDebugEventWithType:@"internal_inconsistency" code:0x1 description:@"FBNativeAdTableViewAdProvider: native ads manager is not valid"];
            r21 = 0x0;
    }
    [r19 release];
    [r20 release];
...
-(void *)tableView:(void *)arg2 nativeAdForRowAtIndexPath:(void *)arg3 {
    var_30 = r24;
    stack[-56] = r23;
...
-(void *)adjustNonAdCellIndexPath:(void *)arg2 forStride:(unsigned long long)arg3 {
    ...
    if ([self isAdCellAtIndexPath:r19 forStride:r20] != 0x0) {
            [FBAdDebugLogging logDebugEventWithType:@"wrong_api_call" code:0x2 description:@"FBNativeAdTableViewAdProvider: adjustNonAdCellIndexPath can only be called for non-ad cells"];
            r20 = 0x0;
    }
    else {
            r0 = [r19 row];
