@implementation FBNativeAdTableViewCell
...
-(void *)initWithStyle:(long long)arg2 reuseIdentifier:(void *)arg3 {
    r31 = r31 - 0x40;
    var_20 = r22;
    stack[-40] = r21;
    var_10 = r20;
    ...
    stack[-8] = r30;
    r29 = &saved_fp;
    r0 = [[&var_30 super] initWithStyle:arg2 reuseIdentifier:arg3];
    r19 = r0;
    if (r0 != 0x0) {
            r21 = [r19 type];
...
-(void *)initWithType:(long long)arg2 withAttributes:(void *)arg3 reuseIdentifier:(void *)arg4 {
    r31 = r31 - 0x40;
    var_20 = r22;
    stack[-40] = r21;
    var_10 = r20;
    ...
    stack[-8] = r30;
    r29 = &saved_fp;
    r0 = [[&var_30 super] initWithStyle:0x1 reuseIdentifier:arg4];
    r19 = r0;
    if (r0 != 0x0) {
            r21 = [r19 type];
            r22 = [[r19 attributes] retain];
...
+(void *)specializeCellForType:(long long)arg2 forAttributes:(void *)arg3 {
    ...
    r0 = [NSString stringWithFormat:@"FBNativeAdTableViewCell-%@"];
    r0 = [r0 retain];
    ...
    [r23 release];
    [r22 release];
    objc_setAssociatedObject(sub_100aab634(r24, [FBNativeAdTableViewCell class], 0x0, 0x0), "type", [[NSNumber numberWithInteger:arg2] retain], 0x1);
    [r20 release];
