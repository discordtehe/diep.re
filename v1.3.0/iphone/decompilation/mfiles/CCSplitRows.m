...
+(void *)actionWithDuration:(double)arg2 rows:(unsigned long long)arg3 {
    r0 = [self alloc];
    r0 = [r0 initWithDuration:arg2 rows:arg3];
    r0 = [r0 autorelease];
    return r0;
}

-(void *)initWithDuration:(double)arg2 rows:(unsigned long long)arg3 {
    r3 = arg3;
    r31 = r31 - 0x30;
    var_10 = r20;
    stack[-24] = r19;
...
-(void *)copyWithZone:(struct _NSZone *)arg2 {
    ...
    r0 = [r0 initWithDuration:self->_rows rows:r3];
    return r0;
}
...
+(void *)actionWithRows:(int)arg2 duration:(double)arg3 {
    r3 = arg3;
    r2 = arg2;
    r0 = self;
    asm { sxtw       x2, w2 };
    r0 = [r0 actionWithDuration:r2 rows:r3];
    return r0;
}

-(void *)initWithRows:(int)arg2 duration:(double)arg3 {
    r3 = arg3;
    r2 = arg2;
    r0 = self;
    asm { sxtw       x2, w2 };
    r0 = [r0 initWithDuration:r2 rows:r3];
    return r0;
}
