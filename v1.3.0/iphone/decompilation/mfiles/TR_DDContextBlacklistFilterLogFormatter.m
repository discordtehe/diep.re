@implementation TR_DDContextBlacklistFilterLogFormatter
...
-(void)addToBlacklist:(unsigned long long)arg2 {
...
-(void)removeFromBlacklist:(unsigned long long)arg2 {
    [self->_contextSet removeFromSet:arg2];
    return;
}

-(bool)isOnBlacklist:(unsigned long long)arg2 {
    r0 = self->_contextSet;
    r0 = [r0 isInSet:arg2];
    return r0;
}
...
-(void *)formatLogMessage:(void *)arg2 {
    ...
    stack[-8] = r30;
    r19 = [arg2 retain];
    if (([self isOnBlacklist:r19->_context] & 0x1) != 0x0) {
            r20 = 0x0;
    }
    else {
