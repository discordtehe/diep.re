@implementation MCPromoDataAccessABtest
...
-(void *)getPropertyValue {
    ...
    saved_fp = r29;
    stack[-8] = r30;
    r19 = [[self->mConfig objectForKey:@"dataAccess"] objectForKey:@"testId"];
    [NSString class];
    if ([r19 isKindOfClass:r2] != 0x0) {
            r0 = [MCPromoDataAccessManager sharedMCPromoDataAccessManager];
            r0 = [r0 groupForTest:r19];
    }
    else {
            r0 = 0x0;
    }
...
-(void *)resolveDataAccess {
    ...
    r0 = [r0 objectForKey:@"valueForGroup"];
    r21 = r0;
    var_190 = q0;
    r0 = [r0 countByEnumeratingWithState:r2 objects:r3 count:r4];
    var_1F0 = r0;
    r23 = 0x0;
    if (r0 == 0x0) goto loc_1009d9648;
...
loc_1009d94e8:
    ...
    var_1E8 = r26;
    r28 = *(var_198 + r26 * 0x8);
    r0 = [r28 objectForKey:@"groups"];
    r25 = r0;
    var_1D0 = q0;
    r0 = objc_msgSend(r0, r22);
    if (r0 == 0x0) goto loc_1009d95f0;
...
loc_1009d955c:
    ...
    r22 = *(var_1D8 + r26 * 0x8);
    if ((objc_msgSend(r22, r24) & 0x1) != 0x0) goto loc_1009d9630;
...
loc_1009d9590:
    ...
    r26 = r26 + 0x1;
    if (r26 < r21) goto loc_1009d955c;

loc_1009d95cc:
    r22 = var_1F8;
    r0 = objc_msgSend(r25, r22);
    r21 = r0;
    if (r0 != 0x0) goto loc_1009d9550;

loc_1009d95f0:
    r26 = var_1E8 + 0x1;
    r25 = var_208;
    r21 = var_200;
    if (r26 < var_1F0) goto loc_1009d94e8;

loc_1009d960c:
    r0 = objc_msgSend(r21, r22);
    var_1F0 = r0;
    if (r0 != 0x0) goto loc_1009d94e4;
