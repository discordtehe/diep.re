@implementation MenuHourlyBonusNotReady
...
-(void)setupWithStateId:(unsigned long long)arg2 parameters:(void *)arg3 {
    ...
    r0 = [r0 nodeGraphFromFile:@"MenuHourlyBonusNotReady.ccbi" owner:self];
    r20 = sign_extend_64(*(int32_t *)ivar_offset(_view));
    *(self + r20) = r0;
    [self->mBaseNode addChild:r0];
    [*(self + r20) setupLayout];
    [self updateHourlyCoinsBonus];
    return;
}
...
-(double)enterWithPreviousState:(unsigned long long)arg2 fromStack:(bool)arg3 {
    ...
    r19 = arg2;
    r20 = self;
    r0 = [self updateHourlyCoinsBonus];
    if ((arg3 & 0x1) == 0x0) {
            r0 = r20->_view;
...
-(double)leaveWithNewState:(unsigned long long)arg2 toStack:(bool)arg3 {
    ...
    r0 = self;
    if ((arg3 & 0x1) == 0x0) {
            sub_10003b12c([[Application sharedApplication] alarmManager]);
            r0 = r20->_view;
