@implementation GADUnifiedNativeAdView
...
-(void)updateMediaView {
    ...
    r25 = sign_extend_64(*(int32_t *)ivar_offset(_nativeAd));
    r0 = *(r20 + r25);
    r0 = [r0 mediaContent];
    r0 = [r0 retain];
    r23 = r0;
    ...
    r20 = [[*(r20 + r25) mediaContent] retain];
    [r19 setMediaContent:r20];
    [r20 release];
    [r22 release];
    [r19 release];
    return;
...
-(void)updateAdChoicesView {
    ...
    r26 = sign_extend_64(*(int32_t *)ivar_offset(_nativeAd));
    r0 = *(r20 + r26);
    ...
    if (r21 != 0x0) {
            ...
            r22 = objc_loadWeakRetained((int64_t *)&r20->_adChoicesView);
            r0 = *(r20 + r26);
            r0 = [r0 internalNativeAd];
            r0 = [r0 retain];
            r25 = r0;
            ...
            r23 = [r0 retain];
            [r25 release];
            r0 = [r23 publisherRenderAdChoicesAllowed];
            if (r22 != 0x0 && r0 != 0x0) {
                    [r22 setAdChoicesContentView:r21];
            }
            else {
