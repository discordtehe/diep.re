...
-(void *)init {
    r0 = [self initWithTotalParticles:0x15e];
    return r0;
}
...
-(void *)initWithTotalParticles:(unsigned long long)arg2 {
    ...
    if (r0 != 0x0) {
            ...
            *(int32_t *)(int64_t *)&r19->_angleVar = 0x43b40000;
            ...
            [r19 setPosition:0x0];
            [r19 setPosVar:0x0];
            *(int32_t *)(r19 + sign_extend_64(*(int32_t *)ivar_offset(_life))) = 0x3f800000;
            *(int32_t *)(int64_t *)&r19->_lifeVar = 0x3f000000;
            *(int32_t *)(int64_t *)&r19->_startSize = 0x41f00000;
