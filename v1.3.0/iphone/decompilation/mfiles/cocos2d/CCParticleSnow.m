...
-(void *)initWithTotalParticles:(unsigned long long)arg2 {
    ...
    if (r0 != 0x0) {
            ...
            *(int32_t *)(int64_t *)&r19->_life = 0x42340000;
            *(int32_t *)(int64_t *)&r19->_lifeVar = 0x41700000;
            *(int32_t *)(int64_t *)&r19->_startSize = 0x41200000;
            *(int32_t *)(int64_t *)&r19->_startSizeVar = 0x40a00000;
            *(int32_t *)(int64_t *)&r19->_endSize = 0xffffffffbf800000;
            *(int32_t *)(int64_t *)&r19->_emissionRate = 0x41200000;
            *(int128_t *)(int64_t *)&r19->_startColor = q0;
            r8 = sign_extend_64(*(int32_t *)ivar_offset(_startColorVar));
            *(int128_t *)(r19 + r8) = 0x0;
            *(int128_t *)(0x8 + r19 + r8) = 0x0;
            *(int128_t *)(int64_t *)&r19->_endColor = *(int128_t *)0x100ba6280;
