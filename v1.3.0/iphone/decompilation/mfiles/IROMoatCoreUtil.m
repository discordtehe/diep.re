@implementation IROMoatCoreUtil
...
+(void *)getAppName {
    if (*qword_1011dae08 != -0x1) {
            dispatch_once(0x1011dae08, 0x100e8ea80);
    }
    r0 = *0x1011c2688;
...
+(void *)getIDFA {
    ...
    r0 = [r0 retain];
    r19 = r0;
    if (([r0 isIDFACollectionBlocked] & 0x1) != 0x0 || [ASIdentifierManager class] == 0x0) goto loc_1007532c8;
