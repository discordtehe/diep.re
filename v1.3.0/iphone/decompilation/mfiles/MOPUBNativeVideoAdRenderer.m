...
-(void)dealloc {
    [*(self + 0x40) invalidate];
    r0 = *(self + 0x40);
    *(self + 0x40) = 0x0;
    [r0 release];
    r0 = [MOPUBPlayerManager sharedInstance];
    r0 = [r0 retain];
    [r0 disposePlayerViewController];
    [r0 release];
...
-(void)willEnterFullscreen:(void *)arg2 {
    r0 = [self adapter];
    r0 = [r0 retain];
    r20 = r0;
    r0 = [r0 delegate];
...
-(void)tick:(void *)arg2 {
    ...
    stack[-8] = r30;
    r19 = self;
    r0 = [self videoController];
    r29 = &saved_fp;
    r0 = [r0 retain];
    [r0 release];
    if (r0 != 0x0) {
            r0 = [r19 videoController];
            r0 = [r0 retain];
            r23 = r0;
            r24 = [[r0 playerView] retain];
            ...
            r0 = [r0 retain];
            r23 = r0;
            r21 = [[r0 playerView] retain];
            r0 = [r19 nativeVideoAdConfig];
            r29 = r29;
            r0 = [r0 retain];
            r22 = r0;
            [r0 pauseVisiblePercent];
            asm { scvtf      s0, x0 };
            asm { fdiv       s0, s0, s1 };
            asm { fcvt       d0, s0 };
            r24 = sub_1004af650();
...
-(void)playerDidProgressToTime:(double)arg2 {
    ...
    r29 = &saved_fp;
    r0 = [r0 retain];
    [r0 handleVideoHasProgressedToTime:arg2];
    [r0 release];
    if (([r19 trackingImpressionFired] & 0x1) == 0x0) {
            r0 = [r19 trackingAgent];
            r29 = r29;
            r0 = [r0 retain];
            r22 = [r0 shouldTrackImpressionWithCurrentPlaybackTime:r2];
            [r0 release];
            if (r22 != 0x0) {
                    [r19 setTrackingImpressionFired:0x1];
                    r0 = [r19 adapter];
                    r0 = [r0 retain];
                    [r0 handleVideoViewImpression];
                    [r0 release];
                    r0 = [r19 vastTracking];
                    r29 = r29;
                    r0 = [r0 retain];
                    [r0 handleVideoEvent:r2 videoTimeOffset:r3];
                    [r20 release];
            }
    }
    r0 = [r19 vastTracking];
...
-(void)ctaTapped:(void *)arg2 {
    r0 = [self adapter];
    r0 = [r0 retain];
    [r0 handleVideoViewClick];
    [r0 release];
    ...
    [r20 handleVideoEvent:0xb videoTimeOffset:r3];
    [r0 release];
    [r19 release];
    [r20 release];
    return;
...
-(void)fullscreenPlayerWillLeaveApplication:(void *)arg2 {
    var_40 = r26;
    stack[-72] = r25;
    r31 = r31 + 0xffffffffffffffb0;
    var_30 = r24;
    ...
    r29 = &saved_fp;
    r0 = [r0 retain];
    r25 = [r0 respondsToSelector:@selector(nativeAdWillLeaveApplicationFromAdapter:)];
    [r0 release];
    [r23 release];
    if (r25 != 0x0) {
            r0 = [r19 adapter];
            ...
            r19 = [[r19 adapter] retain];
            [r22 nativeAdWillLeaveApplicationFromAdapter:r19];
            [r19 release];
            [r22 release];
            [r0 release];
    }
...
loc_100461590:
    ...
    r0 = [r0 retain];
    r24 = r0;
    if (objc_msgSend(r0, r22) == 0x0) goto loc_1004618c0;
...
loc_100461d74:
    ...
    if ([r20 shouldLoadMediaView] != 0x0) {
            ...
            [r24 setFrame:r2];
            objc_msgSend(r24, r28);
            [r24 setUserInteractionEnabled:0x1];
            [r25 setUserInteractionEnabled:0x1];
            [r25 addSubview:r2];
            [r25 release];
            [r24 release];
...
loc_100461bc8:
    ...
    if ([r19 respondsToSelector:r2] == 0x0) goto loc_1004620d8;
...
-(void)enterFullscreen:(void *)arg2 {
    r31 = r31 - 0x90;
    var_50 = r28;
    stack[-88] = r27;
    var_40 = r26;
    ...
    r19 = [arg2 retain];
    r22 = objc_alloc();
    r23 = [[r20 videoController] retain];
    r0 = [r20 adapter];
    r0 = [r0 retain];
    r25 = [[r0 properties] retain];
    r22 = [r22 initWithVideoPlayer:r23 nativeAdProperties:r25 dismissBlock:&var_78];
    [r25 release];
    [r0 release];
    [r23 release];
    [r22 setDelegate:r20];
    ...
    r29 = &saved_fp;
    r0 = [r0 retain];
    r27 = [r0 respondsToSelector:@selector(nativeAdWillPresentModalForAdapter:)];
    [r0 release];
    [r25 release];
    if (r27 != 0x0) {
            r0 = [r20 adapter];
            ...
            r20 = [[r20 adapter] retain];
            [r24 nativeAdWillPresentModalForAdapter:r20];
            [r20 release];
            [r24 release];
            [r0 release];
    }
    [r19 presentViewController:r22 animated:0x0 completion:0x0];
    [r22 release];
    [r19 release];
    return;
}
...
-(void)initAdView {
    ...
    [r0 release];
    if (r0 == 0x0) {
            r22 = [[r19 renderingViewClass] respondsToSelector:r2];
            r0 = [r19 renderingViewClass];
            if (r22 != 0x0) {
                    r0 = [r0 nibForAd];
                    r0 = [r0 retain];
                    r20 = r0;
...
loc_100463aa4:
    ...
    r0 = [r0 properties];
    r0 = [r0 retain];
    r27 = [[r0 objectForKey:*0x100e7eeb0] retain];
    [r19 setVideoConfig:r27];
    [r27 release];
    [r0 release];
    [r20 release];
    r0 = [r19 adapter];
    ...
    r0 = [r0 properties];
    r0 = [r0 retain];
    r25 = [[r0 objectForKey:*0x100e7eec0] retain];
    [r19 setNativeVideoAdConfig:r25];
    [r25 release];
    [r0 release];
    [r20 release];
    r0 = [r19 videoController];
    ...
    if (r0 != 0x0) {
            ...
            if (r26 == 0x0) {
                    ...
                    r25 = [[MOPUBPlayerManager sharedInstance] retain];
                    r26 = [[r19 videoConfig] retain];
                    r27 = [[r19 nativeVideoAdConfig] retain];
                    r28 = [[r25 playerViewControllerWithVideoConfig:r26 nativeVideoAdConfig:r27] retain];
                    [r19 setVideoController:r28];
                    [r28 release];
                    [r27 release];
                    [r26 release];
                    [r25 release];
                    ...
                    r0 = [r0 retain];
                    r24 = r0;
                    r25 = [[r0 defaultActionURL] retain];
                    r0 = [r19 videoController];
                    r0 = [r0 retain];
                    [r0 setDefaultActionURL:r25];
                    [r0 release];
                    [r25 release];
                    [r24 release];
                    r0 = [r19 videoController];
                    r0 = [r0 retain];
                    [r0 setDisplayMode:0x0];
                    [r0 release];
                    r0 = [r19 videoController];
                    r0 = [r0 retain];
                    [r0 setDelegate:r19];
                    ...
                    [r26 release];
                    [r25 release];
                    r24 = [[r19 adView] retain];
                    r0 = [r19 adView];
                    r0 = [r0 retain];
                    r22 = [[r0 nativeVideoView] retain];
                    [r24 bringSubviewToFront:r22];
                    [r22 release];
                    [r0 release];
                    [r24 release];
                    r0 = [r19 autoPlayTimer];
                    r29 = r29;
                    r0 = [r0 retain];
                    [r0 release];
                    if (r0 == 0x0) {
                            r22 = [[MPTimer timerWithTimeInterval:r19 target:@selector(tick:) selector:0x1 repeats:**_NSRunLoopCommonModes runLoopMode:r6] retain];
                            [r19 setAutoPlayTimer:r22];
                            [r22 release];
                            r0 = [r19 autoPlayTimer];
                            r29 = r29;
                            r0 = [r0 retain];
                    ...
                    r23 = @selector(nativeVideoAdConfig);
                    r24 = objc_alloc();
                    r0 = [r19 videoController];
                    r0 = [r0 retain];
                    r21 = r0;
                    r22 = [[r0 playerView] retain];
                    r0 = objc_msgSend(r19, r23);
                    r29 = r29;
                    r0 = [r0 retain];
                    r25 = r0;
                    [r0 impressionMinVisiblePercent];
                    asm { scvtf      s0, x0 };
                    asm { fdiv       s0, s0, s1 };
                    asm { fcvt       d8, s0 };
                    r0 = objc_msgSend(r19, r23);
                    r29 = r29;
                    r0 = [r0 retain];
                    [r0 impressionMinVisibleSeconds];
                    r24 = [r24 initWithVideoView:r22 requiredVisibilityPercentage:r3 requiredPlaybackDuration:r4];
                    [r19 setTrackingAgent:r24];
                    [r24 release];
                    [r0 release];
                    [r25 release];
                    [r22 release];
    ...
    r0 = [r0 retain];
    [r0 release];
    if (r0 == 0x0) goto loc_1004641b8;

loc_100464154:
    if (r23 == 0x0) goto loc_10046425c;

loc_100464158:
    r22 = [[r19 vastTracking] retain];
    r0 = [r19 videoController];
    r0 = [r0 retain];
    r23 = r0;
    r0 = [r0 playerView];
...
loc_10046425c:
    [[r19 vastTracking] retain];
    r0 = [r19 videoController];
    r0 = [r0 retain];
    [r0 setVastTracking:r2];
    [r19 release];
    [r21 release];
    return;
...
loc_1004641b8:
    ...
    r29 = r29;
    r24 = [r0 retain];
    [r25 initWithMPVideoConfig:r22 videoView:r24];
    [r19 setVastTracking:r2];
    [r25 release];
    goto loc_100464244;
}
...
-(void)setVideoController:(void *)arg2 {
    objc_storeWeak(self + 0x38, arg2);
    return;
}

-(void)setAutoPlayTimer:(void *)arg2 {
...
-(void)setNativeVideoAdConfig:(void *)arg2 {
    objc_storeStrong(self + 0x58, arg2);
    return;
}

-(void)setTrackingAgent:(void *)arg2 {
...
-(void)setTrackingImpressionFired:(bool)arg2 {
