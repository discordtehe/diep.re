@implementation VNGMoatBaseTracker
...
-(void *)init {
    ...
    if (r19 != 0x0) {
            ...
            [r19 setName:r21];
            [r21 release];
            r20 = [[NSNumber numberWithLong:r8 - ((SAR(r9, 0x19)) + r9 / 0xffffffff80000000) * 0x5f5e100] retain];
...
-(void *)getViewableState {
    ...
    r19 = [[VNGMoatUIUtil getViewableState:r20] retain];
    [r20 release];
    r0 = [r19 autorelease];
    return r0;
}
...
-(bool)checkFalseStart {
    ...
    r29 = &saved_fp;
    r19 = self;
    if ([self isActive] == 0x0) goto loc_10066cbb0;

loc_10066cb34:
    [VNGMoatLogging reportDevLogWithObject:r19 format:@"Can't start tracking, already active"];
    r21 = @class(VNGMoatLogging);
...
loc_10066cbb0:
    if ([r19 stoppedTracking] == 0x0) goto loc_10066cc4c;

loc_10066cbc4:
    [VNGMoatLogging reportDevLogWithObject:r19 format:@"Can't start tracking, already stopped"];
    r21 = @class(VNGMoatLogging);
    r22 = [[r19 trackerID] retain];
...
-(void)setTrackerID:(void *)arg2 {
    objc_storeStrong((int64_t *)&self->_trackerID, arg2);
    return;
}
