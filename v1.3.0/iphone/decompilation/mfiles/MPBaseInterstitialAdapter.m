...
-(void)_getAdWithConfiguration:(void *)arg2 targeting:(void *)arg3 {
    r21 = [arg2 retain];
    r19 = [arg3 retain];
    [self setConfiguration:r21];
    [self startTimeoutTimer];
    [self getAdWithConfiguration:r21 targeting:r19];
    [r19 release];
    [r21 release];
    return;
}
...
-(void)timeout {
    r20 = [[NSError errorWithCode:0x19 localizedDescription:@"Interstitial ad request timed out"] retain];
    r0 = [self delegate];
    r0 = [r0 retain];
...
-(void)trackImpression {
    ...
    r0 = [self delegate];
    r0 = [r0 retain];
    [r0 interstitialDidReceiveImpressionEventForAdapter:self];
    [r0 release];
    return;
}
