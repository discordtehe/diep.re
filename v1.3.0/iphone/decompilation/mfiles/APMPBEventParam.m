@implementation APMPBEventParam
...
-(void *)initWithBuffer:(void *)arg2 {
    ...
    r0 = calloc(0x1, 0x18);
    r21 = r0;
    if ((sub_1001a3734(r0) & 0x1) != 0x0) {
            r0 = objc_retainAutorelease(r19);
            if ((sub_10019b4b0([r0 bytes], [r0 length], r21) & 0x1) != 0x0) {
...
-(void *)initWithMessageInfo:(union ? *)arg2 {
    ...
    if (r19 != 0x0) {
            if (r20 != 0x0) {
                    if (*(r20 + 0x10) == "EventParam" && (sub_1001a3990((int64_t *)&r19->_messageInfo, r20) & 0x1) != 0x0) {
                            r20 = [r19 retain];
                    }
                    else {
                            r20 = 0x0;
