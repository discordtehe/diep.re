@implementation IROMoatAVVideoTracker
...
-(bool)trackVideoAd:(void *)arg2 player:(void *)arg3 layer:(void *)arg4 {
    ...
    r20 = [arg3 retain];
    r21 = [arg4 retain];
    if ([IROMoatOnOff getStatus] != 0x0 && ([r22 initialized] & 0x1) != 0x0) {
            ...
            [r25 release];
            if ([r22 trackPlayer:r20 adIds:r19 targetLayer:r21] != 0x0) {
                    [IROMoatLogging reportDevLogWithObject:r2 format:r3];
            ...
            r29 = r29;
            r22 = [r0 retain];
            r0 = [r28 onResurrectionDo:&var_A8 withQueue:r22 withKey:r24];
            [r22 release];
...
-(void)registerForEvents {
    ...
    if (r19 != 0x0) {
            ...
            [IROMoatLogging reportDevLogWithObject:r20 format:@"uh-oh, player reference became nil before we kicked off the interval."];
            [r20 destroy];
    }
    [r19 release];
    return;
