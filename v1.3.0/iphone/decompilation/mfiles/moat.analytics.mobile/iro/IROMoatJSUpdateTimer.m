@implementation IROMoatJSUpdateTimer

+(void *)sharedJSUpdateTimer {
    r29 = &saved_fp;
    r31 = r31 + 0xfffffffffffffff0 - 0x30;
    var_28 = *__NSConcreteStackBlock;
    if (*qword_1011dadd0 != -0x1) {
            r0 = dispatch_once(0x1011dadd0, &var_28);
    }
    r0 = *0x1011dadc8;
...
-(void)addActiveTracker:(void *)arg2 {
    ...
    r19 = [arg2 retain];
    var_40 = r19;
    [IROMoatLogging reportDevLogWithObject:r20 format:@"Adding active tracker %@"];
