@implementation GADNativeAppInstallAdView
...
-(void)dealloc {
    [[self->_nativeAppInstallAd retain] retain];
    sub_100860a80();
    [r0 release];
    [r20 release];
...
-(void)setNativeAppInstallAd:(void *)arg2 {
    [arg2 retain];
    objc_storeStrong((int64_t *)&self->_nativeAppInstallAd, arg2);
    var_30 = [self retain];
    [r21 retain];
    sub_100860a80();
    [r21 release];
...
-(void *)nativeAppInstallAd {
    r0 = self->_nativeAppInstallAd;
...
-(void)updateMediaView {
    ...
    stack[-8] = r30;
    r20 = self;
    r19 = objc_loadWeakRetained((int64_t *)&r20->_mediaView);
    r24 = sign_extend_64(*(int32_t *)ivar_offset(_nativeAppInstallAd));
    r0 = *(r20 + r24);
    ...
    r22 = [r0 retain];
    [r23 release];
    if ([r22 hasVideoContent] != 0x0 && [r22 videoPlaybackState] != 0x4) {
            r0 = *(r20 + r24);
            [r0 reportIsMediaContentRendered:r2];
    }
    r20 = [[*(r20 + r24) internalMediaContent] retain];
...
-(void)orderViews {
    ...
    stack[-8] = r30;
    r19 = self;
    r23 = sign_extend_64(*(int32_t *)ivar_offset(_nativeAppInstallAd));
    r0 = *(r19 + r23);
...
-(void)updateAdChoicesView {
    ...
    r25 = sign_extend_64(*(int32_t *)ivar_offset(_nativeAppInstallAd));
    r0 = *(r20 + r25);
...
-(void *)priceView {
    r0 = objc_loadWeakRetained((int64_t *)&self->_priceView);
    r0 = [r0 autorelease];
    return r0;
}

-(void *)storeView {
    r0 = objc_loadWeakRetained((int64_t *)&self->_storeView);
    r0 = [r0 autorelease];
    return r0;
}
...
-(void).cxx_destruct {
    ...
    objc_destroyWeak((int64_t *)&self->_priceView);
    objc_destroyWeak((int64_t *)&self->_storeView);
    ...
    objc_storeStrong((int64_t *)&self->_nativeAppInstallAd, 0x0);
    return;
}
