@implementation APMEventFilter

-(void *)initWithAudienceID:(int)arg2 filterID:(int)arg3 eventName:(void *)arg4 data:(void *)arg5 {
    r31 = r31 - 0x50;
    var_30 = r24;
    stack[-56] = r23;
    var_20 = r22;
    ...
    if (r21 != 0x0) {
            ...
            *(int32_t *)(int64_t *)&r21->_filterID = r22;
            r0 = [r19 copy];
            r9 = sign_extend_64(*(int32_t *)ivar_offset(_eventName));
            r8 = *(r21 + r9);
            *(r21 + r9) = r0;
            [r8 release];
            r0 = [r20 copy];
...
-(void).cxx_destruct {
    ...
    objc_storeStrong((int64_t *)&self->_eventName, 0x0);
    return;
}
