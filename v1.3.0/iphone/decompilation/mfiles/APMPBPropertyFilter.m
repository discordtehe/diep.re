@implementation APMPBPropertyFilter
...
-(void *)initWithMessageInfo:(union ? *)arg2 {
    ...
    if (r19 != 0x0) {
            if (r20 != 0x0) {
                    if (*(r20 + 0x10) == "PropertyFilter" && (sub_1001a6180((int64_t *)&r19->_messageInfo, r20) & 0x1) != 0x0) {
                            r20 = [r19 retain];
                    }
                    else {
                            r20 = 0x0;
                    ...
                    r20 = sign_extend_64(*(int32_t *)ivar_offset(_messageInfo));
                    *(r19 + r20) = r0;
                    if ((sub_1001a5ee4(r0) & 0x1) != 0x0) {
                            r20 = [r19 retain];
                    }
                    else {
                            sub_1001a60ec(*(r19 + r20));
                            r20 = 0x0;
                    }
            }
    }
...
-(void *)initWithBuffer:(void *)arg2 {
    ...
    if ((sub_1001a5ee4(r0) & 0x1) != 0x0) {
            ...
            if ((sub_10019c2a8([r0 bytes], [r0 length], r21) & 0x1) != 0x0) {
