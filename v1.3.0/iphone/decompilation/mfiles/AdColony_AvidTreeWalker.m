@implementation AdColony_AvidTreeWalker

+(void *)getInstance {
    r29 = &saved_fp;
    r31 = r31 + 0xfffffffffffffff0 - 0x30;
    var_28 = *__NSConcreteStackBlock;
    if (*qword_1011d23c8 != -0x1) {
            r0 = dispatch_once(0x1011d23c8, &var_28);
    }
    r0 = *0x1011d23d0;
...
-(void *)init {
    ...
    stack[-24] = r19;
    r29 = &saved_fp;
    *(r31 + 0xffffffffffffffa0) = self;
    r0 = [[&var_50 super] init];
    r19 = r0;
    if (r19 != 0x0) {
            r0 = [AdColony_AvidProcessorFactory new];
            r9 = sign_extend_64(*(int32_t *)ivar_offset(_processorFactory));
            r8 = *(r19 + r9);
            *(r19 + r9) = r0;
            [r8 release];
            r21 = [AdColony_AvidAdViewCache alloc];
            r23 = [[AdColony_AvidAdSessionRegistry getInstance] retain];
            ...
            *(r19 + r9) = r0;
            [r8 release];
            [r23 release];
            r20 = [AdColony_AvidStatePublisher alloc];
            ...
            if (d0 != 0x0) {
                    ...
                    if (r23 != 0x2) {
                            ...
                            *(r22 + r8) = *(r22 + r8) + 0x1;
                            ...
                            [AdColony_AvidDictionaryUtil state:r20 addChildState:r24];
...
-(void)walkChildrenForView:(void *)arg2 processor:(void *)arg3 state:(void *)arg4 type:(unsigned long long)arg5 {
    ...
    r19 = [arg4 retain];
    if (arg5 != 0x0) {
            r0 = [r21 childrenForView:r22];
            r29 = r29;
    }
    else {
            r0 = [r21 orderedChildrenForView:r22];
            r29 = r29;
    }
    r22 = [r0 retain];
    r23 = [r21 processorForChildren];
    [r21 release];
    r21 = [r23 retain];
    var_118 = 0x0;
    r0 = [r22 retain];
...
-(bool)handleAdView:(void *)arg2 withState:(void *)arg3 {
    ...
    if (r21 != 0x0) {
            [AdColony_AvidDictionaryUtil state:r19 addSessionId:r21];
...
-(void)checkFriendlyObstruction:(void *)arg2 withState:(void *)arg3 {
    ...
    if (r20 != 0x0) {
            [AdColony_AvidDictionaryUtil state:r19 addFriendlyObstructionForSessions:r20];
    }
    [r20 release];
    [r19 release];
    return;
