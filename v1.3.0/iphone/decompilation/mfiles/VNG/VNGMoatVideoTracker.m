@implementation VNGMoatVideoTracker
...
-(bool)trackVideoAd:(void *)arg2 usingAVMoviePlayer:(void *)arg3 withLayer:(void *)arg4 withContainingView:(void *)arg5 {
    ...
    r23 = [[VNGMoatAVVideoTracker trackerWithPartnerCode:r24] retain];
    [r24 release];
...
-(void)setManagedTracker:(void *)arg2 {
    objc_storeStrong((int64_t *)&self->_managedTracker, arg2);
    return;
}
