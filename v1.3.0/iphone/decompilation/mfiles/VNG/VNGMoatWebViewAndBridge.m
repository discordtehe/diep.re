@implementation VNGMoatWebViewAndBridge
...
-(void *)init {
    ...
    r29 = &saved_fp;
    r19 = self;
    r20 = NSClassFromString(@"WKWebView");
    if (r20 != 0x0) {
            ...
            if (r19 != 0x0) {
                    ...
                    r21 = [[VNGMoatWKWebViewBridge alloc] initWithWebView:r20 forNativeAd:0x1];
                    [r19 setWebView:r20];
...
-(void)webView:(void *)arg2 didFinishNavigation:(void *)arg3 {
    ...
    stack[-8] = r30;
    r19 = self;
    [VNGMoatLogging reportDevLogWithObject:r19 format:@"Global Native Display WKWebView didFinishNavigation"];
    r0 = [r19 webBridge];
    r29 = &saved_fp;
    r0 = [r0 retain];
    [r0 release];
