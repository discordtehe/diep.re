@implementation MCNNewsFrameViewLandscape
...
-(void *)initWithFrame:(struct CGRect)arg2 xOffset:(float)arg3 {
    memcpy(&r2, &arg2, 0x8);
    r31 = r31 - 0x40;
    var_20 = d9;
    stack[-40] = d8;
    ...
    if (r0 != 0x0) {
            [r19 setOpaque:0x0];
            *(int32_t *)(int64_t *)&r19->_xOffset = s8;
            [r19 setAccessibilityIdentifier:@"NF_LANDSCAPE_FRAME_VIEW"];
    }
    r0 = r19;
    return r0;
}
...
-(void)drawRect:(struct CGRect)arg2 {
    ...
    saved_fp = r29;
    stack[-8] = r30;
    r31 = r31 + 0xffffffffffffff70 - 0x470;
    [self bounds];
    v8 = v1;
    v10 = v3;
    asm { fcvt       d11, s0 };
    ...
    asm { fdiv       d12, d9, d0 };
    asm { fdiv       d10, d10, d0 };
    d15 = (d10 + d12) * 0x3fe0000000000000;
