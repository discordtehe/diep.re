...
-(void *)initWithMessageInfo:(union ? *)arg2 {
    ...
    if (r19 != 0x0) {
            if (r20 != 0x0) {
                    if (*(r20 + 0x10) == "Setting" && (sub_1001a6cb0((int64_t *)&r19->_messageInfo, r20) & 0x1) != 0x0) {
                            r20 = [r19 retain];
                    }
                    else {
                            r20 = 0x0;
                    ...
                    r20 = sign_extend_64(*(int32_t *)ivar_offset(_messageInfo));
                    *(r19 + r20) = r0;
                    if ((sub_1001a6b70(r0) & 0x1) != 0x0) {
                            r20 = [r19 retain];
                    }
                    else {
                            sub_1001a6c54(*(r19 + r20));
                            r20 = 0x0;
                    }
            }
    }
