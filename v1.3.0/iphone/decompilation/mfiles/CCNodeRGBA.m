...
-(void *)init {
    ...
    if (r0 != 0x0) {
            *(int8_t *)(int64_t *)&r0->_realOpacity = 0xff;
            *(int8_t *)(int64_t *)&r0->_displayedOpacity = 0xff;
            *(int32_t *)(int64_t *)&r0->_realColor = 0xffffff;
            *(int32_t *)(int64_t *)&r0->_displayedColor = 0xffffff;
            *(int32_t *)(int64_t *)&r0->_realEmission = 0x0;
            *(int32_t *)(int64_t *)&r0->_displayedEmission = 0x0;
            *(int8_t *)(int64_t *)&r0->_cascadeOpacityEnabled = 0x0;
            *(int8_t *)(int64_t *)&r0->_cascadeColorEnabled = 0x0;
            *(int8_t *)(int64_t *)&r0->_cascadeEmissionEnabled = 0x1;
    }
    return r0;
}
            ...
            if (r10 != 0x0) {
                    ...
                    if (r23 <= r24) {
                            ...
                            do {
                                    r22 = *r23;
                                    if ([r22 conformsToProtocol:@protocol()] != 0x0) {
                                            r21 = r21 & 0xffffffff00000000 | r25;
                                            [r22 updateDisplayedColor:r2];
                                    }
                                    r23 = r23 + 0x8;
                            } while (r23 < r24);
                    }
            ...
            if (r10 != 0x0) {
                    ...
                    if (r23 <= r24) {
                            ...
                            do {
                                    ...
                                    if ([r22 conformsToProtocol:@protocol()] != 0x0) {
                                            r21 = r21 & 0xffffffff00000000 | r25;
                                            [r22 updateDisplayedEmission:r2];
                                    }
                                    r23 = r23 + 0x8;
                            } while (r23 < r24);
                    }
