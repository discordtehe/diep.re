...
-(bool)enableRetinaDisplay:(bool)arg2 {
    ...
    r20 = arg2;
    r19 = self;
    if (arg2 == 0x0) goto loc_10031f324;

loc_10031f30c:
    if (*(int32_t *)0x1011bcc00 != 0x4000000000000000) {
            asm { fccmp      s0, s1, #0x4, ne };
    }
    if (CPU_FLAGS & NE) goto loc_10031f330;
...
loc_10031f35c:
    ...
    if (d0 != 0x3ff0000000000000) goto loc_10031f398;
...
loc_10031f324:
    if (*(int32_t *)0x1011bcc00 == 0x3ff0000000000000) goto loc_10031f434;
}

-(struct CGPoint)convertToGL:(struct CGPoint)arg2 {
    memcpy(&r2, &arg2, 0x8);
    sub_10031f638(&stack[-128]);
    sub_10035b064(&stack[-192], &stack[-128]);
    r8 = 0x10116c000;
    asm { fdiv       s10, s0, s1 };
    [*(r19 + sign_extend_64(*(int32_t *)(r8 + 0x558))) bounds];
    [r19 orientSize:r2];
    asm { fdiv       d0, d2, d0 };
    asm { fcvt       s0, d0 };
    asm { fdiv       d1, d2, d1 };
...
-(void)setView:(void *)arg2 {
    ...
    if (r0->__view != r2) {
            ...
            if (r20 != 0x0) {
                    r9 = 0x1011bcc00;
                    asm { fcvt       d0, s0 };
                    *(int128_t *)(int64_t *)&r19->_winSizeInPixels = q0;
                    if (*(int32_t *)r9 != 0x3ff0000000000000) {
                            [r19 updateContentScaleFactor];
                    }
                    r21 = sign_extend_64(*(int32_t *)ivar_offset(_touchDispatcher));
...
-(bool)shouldAutorotateToInterfaceOrientation:(long long)arg2 {
    ...
    r20 = self;
    r21 = sign_extend_64(*(int32_t *)ivar_offset(_delegate));
    if ([*(self + r21) respondsToSelector:r2] != 0x0) {
            r0 = *(r20 + r21);
            r0 = [r0 shouldAutorotateToInterfaceOrientation:r19];
    }
    else {
            r0 = 0x1;
    }
...
-(void)viewWillDisappear:(bool)arg2 {
    [[&var_10 super] viewWillDisappear:arg2];
    return;
}
...
-(void)didReceiveMemoryWarning {
    [[&var_20 super] purgeCachedData];
    [[&var_30 super] didReceiveMemoryWarning];
    return;
}

-(void)viewDidUnload {
    [[&var_10 super] viewDidUnload];
    return;
}
