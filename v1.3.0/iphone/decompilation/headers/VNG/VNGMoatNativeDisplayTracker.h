...
#ifndef VNGMOATNATIVEDISPLAYTRACKER_H
#define VNGMOATNATIVEDISPLAYTRACKER_H
...
@interface VNGMoatNativeDisplayTracker : VNGMoatBaseTracker <UIGestureRecognizerDelegate>
