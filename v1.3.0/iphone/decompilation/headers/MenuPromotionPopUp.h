...
#ifndef MENUPROMOTIONPOPUP_H
#define MENUPROMOTIONPOPUP_H



@class BaseState;
@class MenuPromotionPopUpView;
@class MCPromoPopup;

@interface MenuPromotionPopUp : BaseState {
    MenuPromotionPopUpView *_view;
    MCPromoPopup *_promoPopup;
}
