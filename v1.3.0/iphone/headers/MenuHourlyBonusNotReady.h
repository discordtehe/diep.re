...
#ifndef MENUHOURLYBONUSNOTREADY_H
#define MENUHOURLYBONUSNOTREADY_H



@class BaseState;
@class MenuHourlyBonusNotReadyView;

@interface MenuHourlyBonusNotReady : BaseState {
    MenuHourlyBonusNotReadyView *_view;
}
