...
#ifndef VNGMOATBASEVIDEOTRACKER_H
#define VNGMOATBASEVIDEOTRACKER_H

@protocol VNGMoatVideoTrackerDelegate;
...
@interface VNGMoatBaseVideoTracker : VNGMoatBaseTracker
...
@property (retain, nonatomic) VNGMoatWebViewAndBridge *mWebViewAndBridge; // ivar: _mWebViewAndBridge
@property (retain, nonatomic) NSTimer *checkTimer; // ivar: _checkTimer
@property (weak, nonatomic) NSObject<VNGMoatVideoTrackerDelegate> *videoTrackerDelegate; // ivar: _videoTrackerDelegate
