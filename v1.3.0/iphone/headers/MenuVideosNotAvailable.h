...
#ifndef MENUVIDEOSNOTAVAILABLE_H
#define MENUVIDEOSNOTAVAILABLE_H



@class BaseState;
@class MenuVideosNotAvailableView;

@interface MenuVideosNotAvailable : BaseState {
    MenuVideosNotAvailableView *_view;
}
