...
#ifndef OMIDTAPJOYSTATEWATCHER_H
#define OMIDTAPJOYSTATEWATCHER_H
...
@interface OMIDtapjoyStateWatcher : NSObject

@property (readonly, nonatomic) BOOL appIsActive;
@property (readonly, nonatomic) NSUInteger appState; // ivar: _appState
@property (weak, nonatomic) NSObject<OMIDtapjoyStateWatcherDelegate> *delegate; // ivar: _delegate
