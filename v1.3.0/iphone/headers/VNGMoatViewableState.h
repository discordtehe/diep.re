...
#ifndef VNGMOATVIEWABLESTATE_H
#define VNGMOATVIEWABLESTATE_H


#import <Foundation/Foundation.h>


@interface VNGMoatViewableState : NSObject

@property BOOL isAttached; // ivar: _isAttached
@property BOOL exceedsMaxLayerCount; // ivar: _exceedsMaxLayerCount
