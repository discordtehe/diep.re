...
#ifndef IROMOATCONFIG_H
#define IROMOATCONFIG_H


#import <Foundation/Foundation.h>


@interface IROMoatConfig : NSObject

@property (nonatomic) BOOL isOn; // ivar: _isOn
@property (nonatomic) BOOL isDebug; // ivar: _isDebug
@property (nonatomic) BOOL isAppLocationBlacklisted; // ivar: _isAppLocationBlacklisted
