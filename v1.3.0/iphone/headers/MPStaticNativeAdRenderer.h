...
#ifndef MPSTATICNATIVEADRENDERER_H
#define MPSTATICNATIVEADRENDERER_H
...
@property (retain, nonatomic) NSObject<MPNativeAdAdapter> *adapter; // ivar: _adapter
...
+(id)rendererConfigurationWithRendererSettings:(id)arg0 additionalSupportedCustomEvents:(id)arg1 ;
