...
#ifndef OMIDTAPJOYVIDEOEVENTS_H
#define OMIDTAPJOYVIDEOEVENTS_H
...
@interface OMIDtapjoyVideoEvents : NSObject {
...
-(void)publishEventWithName:(id)arg0 parameters:(id)arg1 requireImpression:(BOOL)arg2 ;
