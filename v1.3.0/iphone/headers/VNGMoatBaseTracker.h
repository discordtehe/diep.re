...
#ifndef VNGMOATBASETRACKER_H
#define VNGMOATBASETRACKER_H

@protocol VNGMoatTrackerDelegate;
...
@property (weak, nonatomic) NSObject<VNGMoatTrackerDelegate> *trackerDelegate; // ivar: _trackerDelegate
